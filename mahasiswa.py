...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.pushButtonPerbarui.clicked.connect(self.updateData)
        self.pushButtonHapus.clicked.connect(self.deleteData)
    ...
    def createData(self):
        ...
        strsql = "INSERT INTO tbl_mahasiswa VALUES ('" + \
            nama+"', '"+npm+"', '"+kelas+"', '"+mata_prak+"')"
        conn = conndb.conndb()
